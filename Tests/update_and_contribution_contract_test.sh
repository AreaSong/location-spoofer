...
grep -q 'gh-proxy.org/https://raw.githubusercontent.com/AreaSong/location-spoofer/main/version.txt' "$CONFIG" \
  || fail "update detection must prefer this fork's domestic GitHub Raw mirror"
